            ...
            <main>
                ...
                <section className="secao-nossos-eventos">
                    <div className="texto-secao-nossos-eventos">
                        ...
                        <p>Mais do que uma sorveteria, uma extensão de sua casa! Estamos aqui prontinhos para te atender e ofrecer os melhores eventos com os melhores sorvetes da sua vida! Venha nos conhecer e passar um tempo aqui com a gente.</p>
                    </div>
